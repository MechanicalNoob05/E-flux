...
function MyTabs(props) {
    ...
    return (
        ...
        >
            ...
            <Tab.Screen name="Profile" component={Profile_Stack} options={{tabBarIcon:()=><Ionicons name='person-outline' size={20}/>,tabBarShowLabel:false,tabBarActiveBackgroundColor:'blue'}}/>
        </Tab.Navigator>
    );
}
